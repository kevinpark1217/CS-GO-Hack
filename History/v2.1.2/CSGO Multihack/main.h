...
const DWORD DwCrosshairId = 0x8D04;
const DWORD DwVecViewOrigin = 0x104;
const DWORD DwVecOrigin = 0x134;
const DWORD DwVecPunch = 0x13FC;
const DWORD DwTeamNumber = 0xF0;
const DWORD DwPendingTeamNumber = 0xF4;
const DWORD DwShotsFired = 0x8660;
...
const DWORD DwFlash = 0x86A4;
const DWORD DwFlashDuration = 0x86A8;
